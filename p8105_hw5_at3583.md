...
**This homework applied Monte Carlo methods, hypothesis testing, and
proportion confidence intervals to examine probability, power, and
uncertainty in simulated and real-world data.**
...
toward **1**. This illustrates the fundamental principle that the
expected relationship that larger effect sizes yield greater power in
hypothesis testing.
...
significant results, introducing selection bias.
...
![](p8105_hw5_at3583_files/figure-gfm/unnamed-chunk-11-1.png)<!-- -->

Summary: Across the 50 cities, the proportion of homicides that remain
unsolved varies substantially, ranging from **0** to **0.74**. Cities
with higher unsolved proportions tend to have wider confidence
intervals, reflecting greater uncertainty that often stems from smaller
total case counts. Baltimore falls among the cities with a notably high
share unsolved cases.
